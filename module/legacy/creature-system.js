/**
 * [已冻结] combat-system.js - 回合制战术引擎（AI 叙事战斗架构下无调用方）
 *
 * 冻结原因：本项目战斗由「AI 叙述 + 世界书规则（战斗检定/战斗规则）+ 骰子池」驱动，
 * 本模块的回合制实现无任何调用方；其读取的 equipment-system 单例与 gameData.equipment
 * 构成双状态源暗雷，故移入 legacy 冻结。
 * 数据权威源：世界书「生物总纲」（危险等级表）/「战斗检定」/「战斗规则」；
 * 生物内容已整合至 data-source/世界书/生物/*.yaml（含本模块独有 10 只的迁移版）。
 * 若未来需要战术化战斗：解冻时须重写，并收口 equipment 状态源。
 */
/**
